...
Phase 6E owns the coordinated core/DMS clean-break: quiesce `0.2`, install paired
artifacts inactive, import and cold-validate a staged generation, commit once,
install the trusted replacement hooks, and perform the first accepted-version
exact UUID resume.
